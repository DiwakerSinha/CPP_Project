...
public:
  ...
  int Minimum(int x, int y) const;
  int Minimum(int x, int y, int z) const;
  void ZeroRow(int row, int col);
  void ZeroColumn(int row, int col);
  void LastRow(int row, int col);
  void LastColumn(int row, int col);
  void Internal(int row, int col);
  // void EnergyIni() const;
  /**
